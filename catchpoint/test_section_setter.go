...
func setAdvancedSettings(testTypeId int, advanced_setting map[string]interface{}, testConfig *TestConfig) {
	...
	test_flags := [28]string{"verify_test_on_failure", "debug_primary_host_on_failure", "enable_http2", "debug_referenced_hosts_on_failure", "capture_http_headers", "capture_response_content", "ignore_ssl_failures", "host_data_collection_enabled", "zone_data_collection_enabled", "40x_or_50x_http_mark_successful", "30x_redirects_do_not_follow", "enable_self_versus_third_party_zones", "allow_test_download_limit_override", "capture_filmstrip", "capture_screenshot", "stop_test_on_document_complete", "disable_cross_origin_iframe_access", "stop_test_on_dom_content_load", "enable_path_mtu_discovery", "protocol", "disable_recursive_resolution", "enable_bind_hostname", "enable_tcp_protocol", "enable_nsid", "enable_dnssec", "favor_fastest_round_trip_nameserver", "try_next_nameserver_on_failure", "certificate_revocation_disabled"}
