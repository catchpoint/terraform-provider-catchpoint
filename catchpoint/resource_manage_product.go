							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									...
									"connection": {
										...
										MaxItems:    1,
										Optional:    true,
										Description: "Optional. Sets the connection header for product url if child_host_pattern attribute is omitted",
										Elem: &schema.Resource{
											Schema: map[string]*schema.Schema{
												"value": {
													Type:     schema.TypeString,
									...
									"dns_resolver_override": {
										...
										MaxItems:    1,
										Optional:    true,
										Description: "Optional. Sets the dns_resolver_override header for product url if child_host_pattern attribute is omitted",
										Elem: &schema.Resource{
											Schema: map[string]*schema.Schema{
												"value": {
													Type:     schema.TypeString,
									...
									"sni_override": {
										...
										MaxItems:    1,
										Optional:    true,
										Description: "Optional. Sets the sni_override header for product url if child_host_pattern attribute is omitted",
										Elem: &schema.Resource{
											Schema: map[string]*schema.Schema{
												"value": {
													Type:     schema.TypeString,
									...
									"custom": {
										...
										MaxItems:    1,
										Optional:    true,
										Description: "Optional. Sets the custom header for product url if child_host_pattern attribute is omitted",
										Elem: &schema.Resource{
											Schema: map[string]*schema.Schema{
												"value": {
													Type:     schema.TypeString,
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"alert_setting_type": {
							...
							Optional:     true,
							Default:      "override",
							Description:  "Specifies the type of alert setting: 'override'.",
							ValidateFunc: validation.StringInSlice([]string{"override"}, false),
						},
						"alert_rule": {
							Type:        schema.TypeSet,
							Optional:    true,
