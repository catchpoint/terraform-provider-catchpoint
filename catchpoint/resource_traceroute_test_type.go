			...
			"advanced_settings": {
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"viewport_height": {
							Type:        schema.TypeInt,
							Description: "Optional. Set the viewport height",
							Optional:    true,
							Default:     0,
						},
						"viewport_width": {
							Type:        schema.TypeInt,
							Description: "Optional. Set the viewport width",
							Optional:    true,
							Default:     0,
						},
						"max_step_runtime_sec_override": {
							Type:        schema.TypeInt,
							Description: "Optional. Set the max step runtime in seconds override",
							Optional:    true,
							Default:     0,
						},
						"wait_for_no_activity": {
							Type:        schema.TypeInt,
							Description: "Optional. Set the wait for no activity",
							Optional:    true,
							Default:     nil,
						},
						"edns_subnet": {
							Type:        schema.TypeString,
							Description: "Optional. Set the EDNS subnet",
							Optional:    true,
							Default:     "",
						},
						"additional_monitor": {
