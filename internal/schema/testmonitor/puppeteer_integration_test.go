...
func TestPuppeteerTestResourceSchemaContainsExpectedFields(t *testing.T) {
	ctx := context.Background()
	schema := BuildPuppeteerTestSchema(ctx)
	...
	testutil.AssertElementsMatch(t, "PuppeteerTestResourceSchemaAttributes", cpschema.GetAttributeKeys(schema.Attributes), expectedFields)
	...
	testutil.AssertElementsMatch(t, "PuppeteerTestResourceSchemaBlocks", cpschema.GetBlockKeys(schema.Blocks), expectedBlocks)
}

func TestPuppeteerTestResourceSchemaContainsExpectedAdvancedSettingsFields(t *testing.T) {
	ctx := context.Background()
	schema := BuildPuppeteerTestSchema(ctx)
	...
	if !ok {
		t.Errorf("expected advanced_settings to be present for Puppeteer test schema")
	}

	testutil.AssertElementsMatch(t, "AdvancedSettings", cpschema.GetAttributeKeys(singleNested), expectedFields)
}

func TestPuppeteerTestResourceSchemaContainsExpectedAlertSettingsFields(t *testing.T) {
	ctx := context.Background()
	schema := BuildPuppeteerTestSchema(ctx)
...
func TestPuppeteerTestResourceSchemaContainsExpectedInsightSettingsFields(t *testing.T) {
	ctx := context.Background()
	schema := BuildPuppeteerTestSchema(ctx)
	...
	if !ok {
		t.Errorf("expected insights to be present for Puppeteer test schema")
	}

	testutil.AssertElementsMatch(t, "Insights", cpschema.GetAttributeKeys(singleNested), expectedFields)
}

func TestPuppeteerTestResourceSchemaContainsExpectedRequestSettingsFields(t *testing.T) {
	ctx := context.Background()
	schema := BuildPuppeteerTestSchema(ctx)
	...
	if !ok {
		t.Errorf("expected request_settings to be present for Puppeteer test schema")
	}
...
func TestPuppeteerTestResourceSchemaContainsExpectedScheduleSettingsFields(t *testing.T) {
	ctx := context.Background()
	schema := BuildPuppeteerTestSchema(ctx)
	...
	if !ok {
		t.Errorf("expected schedule_settings to be present for Puppeteer test schema")
	}
