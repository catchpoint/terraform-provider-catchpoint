...
page_title: "transaction_test Resource - terraform-provider-catchpoint"
subcategory: ""
description: |-
...
- `monitor` (String) The monitor to use for the Transaction Test. Supported: 'chrome','mobile','emulated'
